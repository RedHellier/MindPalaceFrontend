  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-50 p-8 font-[family-name:var(--font-geist-sans)]">
      ...
      >
        ...
        <div>
          <label htmlFor="design" className="block text-sm font-medium text-gray-600 mb-1">
            Design
          </label>
          <select
            id="design"
        ...
        <div>
          <label htmlFor="colour" className="block text-sm font-medium text-gray-600 mb-1">
            Colour
          </label>
          <select
            id="colour"
          ...
          >
            <option value="text-black" className="text-black">Black</option>
            <option value="text-blue-500" className="text-blue-500">Blue</option>
            <option value="text-red-500" className="text-red-500">Red</option>
          </select>
        </div>
